import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as e,c as n,f as a}from"./app-dhNUlJ1D.js";const s={},t=a(`<h3 id="一、git安装后-指定名称和邮箱" tabindex="-1"><a class="header-anchor" href="#一、git安装后-指定名称和邮箱" aria-hidden="true">#</a> 一、git安装后-指定名称和邮箱</h3><div class="language-git line-numbers-mode" data-ext="git"><pre class="language-git"><code><span class="token comment"># 全局配置</span>
