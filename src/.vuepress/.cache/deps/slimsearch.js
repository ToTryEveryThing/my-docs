...
var A = class {
    ...
    if (n === void 0) {
      ...
      for (const r of s.keys())
        if (r !== F && r.startsWith(i)) {
          ...
          return u.set(r.slice(i.length), s.get(r)), new A(u, e);
        }
    }
    return new A(n, e);
  }
  ...
  static fromObject(e) {
    return A.from(Object.entries(e));
  }
};
var E = (t, e, n = []) => {
...
var I = (t, e) => {
  ...
  for (const n of t.keys())
    if (n !== F && e.startsWith(n))
      return I(t.get(n), e.slice(n.length));
};
var b = (t, e) => {
  const n = e.length;
  t:
...
var At = { [O]: (t, e) => {
  for (const n of e.keys()) {
    ...
    if (o == null)
      ...
      o.score = o.score + s, o.match = Object.assign(o.match, r), Y(o.terms, i);
    }
  }
  return t;
}, [K]: (t, e) => {
  ...
  for (const o of e.keys()) {
    ...
    Y(s.terms, r), n.set(o, { score: s.score + i, terms: s.terms, match: Object.assign(s.match, u) });
  }
  return n;
}, [pt]: (t, e) => {
  for (const n of e.keys())
...
var zt = { k: 1.2, b: 0.7, d: 0.5 };
var M = { idField: "id", extractField: (t, e) => t[e], tokenize: (t) => t.split(Ft), processTerm: (t) => t.toLowerCase(), fields: void 0, searchOptions: void 0, storeFields: [], logger: (t, e) => {
  typeof (console == null ? void 0 : console[t]) == "function" && console[t](e);
}, autoVacuum: true };
var Z = { combineWith: O, prefix: false, fuzzy: false, maxFuzzy: 6, boost: {}, weights: { fuzzy: 0.45, prefix: 0.375 }, bm25: zt };
var xt = { combineWith: K, prefix: (t, e, n) => e === n.length - 1 };
var T = { batchSize: 1e3, batchWait: 10 };
var B = { minDirtFactor: 0.1, minDirtCount: 20 };
var L = { ...T, ...B };
var Et = (t) => {
...
var et = (t, e) => t._idToShortId.has(e);
var vt = (t, e) => {
...
var j = (t, e, n, o) => {
  ...
  const s = t._index.fetch(o, X), i = s.get(e);
  i == null || i.get(n) == null ? nt(t, n, e, o) : i.get(n) <= 1 ? i.size <= 1 ? s.delete(e) : i.delete(n) : i.set(n, i.get(n) - 1), t._index.get(o).size === 0 && t._index.delete(o);
};
var St = (t, e, n, o, s) => {
...
var bt = (t, e, n = {}) => {
  const { chunkSize: o = 10 } = n, s = { chunk: [], promise: Promise.resolve() }, { chunk: i, promise: r } = e.reduce(({ chunk: u, promise: c }, d, a) => (u.push(d), (a + 1) % o === 0 ? { chunk: [], promise: c.then(() => new Promise((h) => setTimeout(h, 0))).then(() => q(t, u)) } : { chunk: u, promise: c }), s);
  return r.then(() => q(t, i));
};
var st = (t, e = O) => {
  if (t.length === 0)
  ...
  return t.reduce(At[n]) || /* @__PURE__ */ new Map();
};
var W = (t, e, n, o, s, i, r, u, c = /* @__PURE__ */ new Map()) => {
  ...
  for (const d of Object.keys(i)) {
    ...
    for (const l of f.keys()) {
      ...
      if (!m)
        continue;
      const w = f.get(l), p = t._fieldLength.get(l)[h], S = Ct(w, _, t._documentCount, p, g, u), z = o * a * m * S, C = c.get(l);
      if (C) {
        C.score += z, wt(C.terms, e);
        const x = V(C.match, n);
...
var kt = (t, e, n) => {
  const o = { ...t._options.searchOptions, ...n }, s = (o.fields || t._options.fields).reduce((l, m) => ({ ...l, [m]: V(o.boost, m) || 1 }), {}), { boostDocument: i, weights: r, maxFuzzy: u, bm25: c } = o, { fuzzy: d, prefix: a } = { ...Z.weights, ...r }, h = t._index.get(e.term), f = W(t, e.term, e.term, 1, h, s, i, c);
  let _, g;
...
var it = (t, e, n = {}) => {
  ...
  const { tokenize: o, processTerm: s, searchOptions: i } = t._options, r = { tokenize: o, processTerm: s, ...i, ...n }, { tokenize: u, processTerm: c } = r, d = u(e).flatMap((a) => c(a)).filter((a) => !!a).map(yt(r)).map((a) => kt(t, a, r));
...
var ct = (t, e) => {
  if (e == null)
    return true;
  const { minDirtCount: n = L.minDirtCount, minDirtFactor: o = L.minDirtFactor } = e;
  return t.dirtCount >= n && t.dirtFactor >= o;
};
var dt = async (t, e, n) => {
  const o = t._dirtCount;
  if (ct(t, n)) {
    const s = e.batchSize || T.batchSize, i = e.batchWait || T.batchWait;
    let r = 1;
...
var lt = (t, e, n) => t._currentVacuum ? (t._enqueuedVacuumConditions = t._enqueuedVacuumConditions && n, t._enqueuedVacuum != null || (t._enqueuedVacuum = t._currentVacuum.then(() => {
  ...
  return t._enqueuedVacuumConditions = B, dt(t, e, o);
...
export {
  ...
  N as discard,
  Bt as discardAll,
  Et as getDefaultValue,
  vt as getStoredFields,
  et as has,
  rt as loadIndex,
  Mt as loadJSONIndex,
  ft as remove,
