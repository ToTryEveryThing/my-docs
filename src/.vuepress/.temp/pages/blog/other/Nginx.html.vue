<template><div><p><a href="https://nginx.p2hp.com/en/download.html" target="_blank" rel="noopener noreferrer">nginx: 下载 (p2hp.com)<ExternalLinkIcon/></a></p>
...
<p>配置</p>
<blockquote>
<p>只需要添加代理地址，当访问localhost:80时，会代理到<a href="http://127.0.0.1:9090" target="_blank" rel="noopener noreferrer">http://127.0.0.1:9090<ExternalLinkIcon/></a></p>
...
<p>配置</p>
<div class="language-nginx line-numbers-mode" data-ext="nginx"><pre v-pre class="language-nginx"><code><span class="token directive"><span class="token keyword">upstream</span> serverList</span><span class="token punctuation">{</span>
...
<p>访问 <a href="http://127.0.0.1/test" target="_blank" rel="noopener noreferrer">127.0.0.1/test<ExternalLinkIcon/></a></p>
</blockquote>
<img src="https://cdn.beink.cn/study/image-20240820155440975.png" alt="负载均衡效果图"/>
<h2 id="nginx-conf" tabindex="-1"><a class="header-anchor" href="#nginx-conf" aria-hidden="true">#</a> nginx.conf</h2>
<div class="language-nginx line-numbers-mode" data-ext="nginx"><pre v-pre class="language-nginx"><code><span class="token comment"># 定义配置文件的全局块，可以设置一些影响 Nginx 服务器整体运行的指令</span>
