...
<div class="language-git line-numbers-mode" data-ext="git"><pre v-pre class="language-git"><code>$ mkdir learngit	//创建
$ cd learngit	//使用
$ pwd	//查看当前目录
...
<div class="language-git line-numbers-mode" data-ext="git"><pre v-pre class="language-git"><code><span class="token command">$ git add test.txt	//添加</span>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>$ git log	//查看提交历史记录，从最近到最远，可以看到3次
